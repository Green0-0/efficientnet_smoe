...
class EfficientNetB0(nn.Module):
    def __init__(self, num_classes=1010, dropout_rate=0.2, stochastic_depth_prob=0.2):
        super().__init__()
...
def objective(trial):
    ...
    run = wandb.init(
        ...
        config={
            ...
            "optimizer": "RMSProp",
            "model": "EfficientNet-B0 (iNat 2019, 1010 classes)",
    ...
    print(
        f"LR: {lr:.6f} | Batch Size: {batch_size} | Grad Accum: {grad_accum_steps} | Global BS: {global_batch_size}"
    )
